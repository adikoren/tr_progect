...
resource "azurerm_subnet" "az_snet_db_tr_westus" {
...
resource "azurerm_subnet" "az_snet_webapp_tr_westus" {
...
resource "azurerm_subnet_network_security_group_association" "az_snetsgas_webapp" {
  subnet_id                 = azurerm_subnet.az_snet_webapp_tr_westus.id
